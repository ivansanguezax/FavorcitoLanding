...
const PendingProfileState = ({  onRefresh }) => {
      ...
      <div className="md:w-1/2 p-6 md:p-8">
        ...
        <div className="bg-primary-light/10 px-4 md:px-6 py-3 md:py-4 rounded-lg border border-primary-light/20 mb-4 md:mb-5">
          ...
          <p className="text-sm text-primary-dark/80">
            ...
            En breve nos pondremos en contacto para completar tu perfil.
          </p>
        </div>
        ...
        <div className="flex flex-col space-y-3 w-full">
          ...
          <Button
            ...
            className="bg-transparent text-primary-dark border border-primary-dark rounded-lg px-4 py-2 hover:bg-primary-light/10"
