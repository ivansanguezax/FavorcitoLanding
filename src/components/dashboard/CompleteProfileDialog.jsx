...
const CompleteProfileDialog = ({ visible, onHide, studentData }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    availability: studentData?.availability || {
      // Aquí está el error, "Miercoles" debe ser "Miércoles"
      Lunes: [],
      Martes: [],
      Miércoles: [], // Corregido con tilde
      Jueves: [],
      Viernes: [],
      Sábado: [], // Añadir tilde a Sábado también
      Domingo: [],
    },
    classSchedule: "",
  });
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.current.show({
        ...
        detail:
          "Tu información ha sido actualizada. Ahora está en proceso de verificación.",
        life: 5000,
      });
